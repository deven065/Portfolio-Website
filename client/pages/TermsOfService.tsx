  ...
  return (
    <>
      ...
      <Layout>
        ...
        <section className="relative py-20 sm:py-28 lg:py-32 px-6 sm:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#2563EB]/10 mb-4">
              <Gavel className="w-8 h-8 text-[#2563EB]" />
            </div>
        ...
        <section className="py-12 px-6 sm:px-8 lg:px-12 max-w-5xl mx-auto space-y-12">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">1. Acceptance of Terms</h2>
                <p className="text-[#64748B]">By using our services, you acknowledge that you have read, understood, and agree to these Terms.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">2. Services Description</h2>
                <p className="text-[#64748B]">We provide various digital services to help businesses grow online.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B] mb-4">Our services include, but are not limited to:</p>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">3. User Obligations</h2>
                <p className="text-[#64748B]">As a user of our services, you agree to certain responsibilities and obligations.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B] mb-4">You agree to:</p>
              <ul className="space-y-3 text-[#64748B]">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">4. Intellectual Property Rights</h2>
                <p className="text-[#64748B]">Ownership and usage rights for intellectual property created during our engagement.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.1 Ownership</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.2 License Grants</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.3 Restrictions</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">5. Payment Terms</h2>
                <p className="text-[#64748B]">Terms and conditions for payment of services.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">5.1 Fees and Billing</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">5.2 Payment Methods</h3>
                <p className="text-[#64748B] mb-3">We accept payments through:</p>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">5.3 Late Payments</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">5.4 Refund Policy</h3>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">6. Project Scope and Changes</h2>
                <p className="text-[#64748B]">Managing project requirements and change requests.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">7. Warranties and Representations</h2>
                <p className="text-[#64748B]">Our commitments regarding service quality.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B] mb-4">We warrant that:</p>
              <ul className="space-y-2 text-[#64748B]">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">8. Disclaimer of Warranties</h2>
                <p className="text-[#64748B]">Important limitations on warranties.</p>
              </div>
            </div>

            <div className="ml-16">
              <div className="p-4 bg-yellow-100 border border-yellow-200 rounded-lg mb-4">
                <p className="text-yellow-800 text-sm font-semibold mb-2">EXCEPT AS EXPRESSLY PROVIDED IN SECTION 7:</p>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">9. Limitation of Liability</h2>
                <p className="text-[#64748B]">Limits on our liability for damages.</p>
              </div>
            </div>

            <div className="ml-16">
              <div className="p-4 bg-red-50 border border-red-200 rounded-lg mb-4">
                <p className="text-red-800 text-sm font-semibold mb-2">TO THE MAXIMUM EXTENT PERMITTED BY LAW:</p>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">10. Indemnification</h2>
                <p className="text-[#64748B]">Your agreement to protect us from certain claims.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">11. Termination</h2>
                <p className="text-[#64748B]">How and when the agreement can be terminated.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">11.1 Termination by You</h3>
                <p className="text-[#64748B]">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">11.2 Termination by Us</h3>
                <p className="text-[#64748B] mb-3">We may terminate or suspend services immediately if:</p>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">11.3 Post-Termination</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">12. Dispute Resolution</h2>
                <p className="text-[#64748B]">How disputes will be resolved.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">12.1 Negotiation</h3>
                <p className="text-[#64748B]">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">12.2 Arbitration</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">12.3 Exception</h3>
                <p className="text-[#64748B]">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">13. Governing Law and Jurisdiction</h2>
                <p className="text-[#64748B]">The laws that govern these Terms.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">14. Changes to These Terms</h2>
                <p className="text-[#64748B]">We may update these Terms from time to time.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">15. Contact Information</h2>
                <p className="text-[#64748B]">Questions about these Terms? We're here to help.</p>
              </div>
            </div>
            ...
            <div className="ml-16">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#64748B] text-sm">General Inquiries</p>
                    <a href="mailto:contact@devendigitallabs.com" className="text-[#2563EB] hover:text-[#2563EB]/90 text-lg">
        ...
        {/* Footer Note */}
        <section className="py-12 px-6 sm:px-8 lg:px-12 max-w-5xl mx-auto">
          <div className="bg-[#2563EB]/10 border border-[#2563EB]/20 rounded-2xl p-8 text-center">
            <p className="text-[#64748B] text-sm">
