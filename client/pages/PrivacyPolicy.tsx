        ...
        <section className="py-12 px-6 sm:px-8 lg:px-12 max-w-5xl mx-auto">
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="prose max-w-none">
              ...
              <p className="text-[#64748B] text-lg leading-relaxed mt-4">
        ...
        <section className="py-12 px-6 sm:px-8 lg:px-12 max-w-5xl mx-auto space-y-12">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">1. Information We Collect</h2>
                <p className="text-[#64748B]">We collect information that you provide directly to us and information automatically collected when you use our services.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">1.1 Personal Information You Provide</h3>
                <p className="text-[#64748B] mb-3">We may collect the following personal information when you:</p>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">1.2 Information Automatically Collected</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">2. How We Use Your Information</h2>
                <p className="text-[#64748B]">We use the collected information for various purposes related to our business operations.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">3. Legal Basis for Processing (GDPR)</h2>
                <p className="text-[#64748B]">For users in the European Economic Area, we process your data based on the following legal grounds.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">4. Information Sharing and Disclosure</h2>
                <p className="text-[#64748B]">We may share your information with trusted third parties in specific circumstances.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.1 Service Providers</h3>
                <p className="text-[#64748B] mb-3">We may share information with third-party service providers who help us operate our business:</p>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.2 Legal Requirements</h3>
                <p className="text-[#64748B]">We may disclose information if required by law or to:</p>
                <ul className="space-y-2 text-[#64748B] mt-3">
                  <li className="flex items-start gap-2">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">4.3 Business Transfers</h3>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">5. Data Security</h2>
                <p className="text-[#64748B]">We implement industry-standard security measures to protect your information.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B] mb-4">We take data security seriously and employ various measures including:</p>
              <ul className="space-y-2 text-[#64748B]">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">6. Data Retention</h2>
                <p className="text-[#64748B]">We retain your information only as long as necessary for legitimate business purposes.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">7. Your Rights and Choices</h2>
                <p className="text-[#64748B]">You have various rights regarding your personal information depending on your location.</p>
              </div>
            </div>

            <div className="space-y-6 ml-16">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">7.1 GDPR Rights (EU Users)</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">7.2 CCPA Rights (California Users)</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#2563EB]">7.3 Indian IT Act Rights</h3>
                <ul className="space-y-2 text-[#64748B]">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
              ...
              <div className="mt-4 p-4 bg-[#2563EB]/10 border border-[#2563EB]/20 rounded-lg">
                <p className="text-[#2563EB] text-sm">
                  To exercise any of these rights, please contact us at <a href="mailto:privacy@devendigitallabs.com" className="underline hover:text-[#2563EB]/90">privacy@devendigitallabs.com</a>. We will respond to your request within 30 days.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">8. Cookies and Tracking Technologies</h2>
                <p className="text-[#64748B]">We use cookies and similar technologies to enhance your experience.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B] mb-4">We use the following types of cookies:</p>
              <ul className="space-y-3 text-[#64748B]">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#2563EB] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">9. International Data Transfers</h2>
                <p className="text-[#64748B]">Your information may be transferred and stored in different countries.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">10. Children's Privacy</h2>
                <p className="text-[#64748B]">Our services are not directed to individuals under 18 years of age.</p>
              </div>
            </div>

            <div className="ml-16">
              <p className="text-[#64748B]">
                We do not knowingly collect personal information from individuals under 18 years of age. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately at <a href="mailto:privacy@devendigitallabs.com" className="text-[#2563EB] hover:text-[#2563EB]/90 underline">privacy@devendigitallabs.com</a>. We will take steps to delete such information from our systems.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">11. Third-Party Links</h2>
                <p className="text-[#64748B]">We are not responsible for the privacy practices of external websites.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">12. Changes to This Privacy Policy</h2>
                <p className="text-[#64748B]">We may update this policy from time to time to reflect changes in our practices or legal requirements.</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">13. Grievance Officer</h2>
                <p className="text-[#64748B]">As required by Indian IT Act 2000, we have designated a Grievance Officer.</p>
              </div>
            </div>
            ...
            <div className="ml-16">
              ...
              <div className="bg-[#2563EB]/10 border border-[#2563EB]/20 rounded-lg p-4">
                <p className="text-[#64748B]">
                  <strong className="text-[#2563EB]">Email:</strong> <a href="mailto:privacy@devendigitallabs.com" className="text-[#2563EB] hover:text-[#2563EB]/90 underline">privacy@devendigitallabs.com</a>
                </p>
                <p className="text-[#64748B] mt-2">
                  <strong className="text-[#2563EB]">Response Time:</strong> We will acknowledge your complaint within 48 hours and respond within 30 days.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2 text-[#0F172A]">Contact Information</h2>
                <p className="text-[#64748B]">Questions about this Privacy Policy? We're here to help.</p>
              </div>
            </div>
            ...
            <div className="ml-16">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#64748B] text-sm">Privacy Email</p>
                    <a href="mailto:privacy@devendigitallabs.com" className="text-[#2563EB] hover:text-[#2563EB]/90 text-lg">
