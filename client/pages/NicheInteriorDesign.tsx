            ...
            <Layout>
                ...
                <section className="relative pt-12 pb-20 px-6 sm:px-8 lg:px-12 overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        <div className="inline-block px-4 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-full text-amber-600 text-sm font-bold shadow-sm">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight leading-[1.1] text-[#0F172A]">
                            A Website as Stunning as Your <span className="text-amber-500">Design Projects</span>
                        </h1>
                        ...
                        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link to="/contact">
                                <Button size="cta" className="bg-amber-500 hover:bg-amber-600 border-none text-white font-black px-8 py-6 rounded-xl shadow-md hover:shadow-lg transition-all group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {features.map((feature, idx) => (
                            <div key={idx} className="flex gap-6 items-start group">
                                <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-amber-50 border border-amber-200 shadow-sm flex items-center justify-center text-amber-600 group-hover:scale-110 transition-transform">
                                    {feature.icon}
                                </div>
                                <div>
                                    <h3 className="text-2xl font-bold text-[#0F172A] mb-2">{feature.title}</h3>
                ...
                <section className="py-24 px-6 sm:px-8 lg:px-12 text-center max-w-4xl mx-auto">
                    <div className="bg-white rounded-3xl p-10 sm:p-16 border border-[#E2E8F0] shadow-xl relative overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-transparent z-0 pointer-events-none"></div>
                        <div className="relative z-10">
                            <h2 className="text-3xl sm:text-4xl font-black text-[#0F172A] mb-6">Let's build your dream portfolio.</h2>
                            ...
                            <Link to="/contact">
                                <Button size="cta" className="bg-amber-500 hover:bg-amber-600 text-white font-black px-10 py-6 rounded-xl transition-all hover:px-12 shadow-md">
                                    Start Your Project
                                </Button>
                            </Link>
                        </div>
                        ...
                        <div className="absolute -top-10 -right-10 opacity-5 transform rotate-12 group-hover:scale-110 transition-transform duration-1000">
                            <PenTool className="w-64 h-64 text-amber-500" />
                        </div>
                    </div>
                </section>
            </Layout>
