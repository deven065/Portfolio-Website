  ...
  const projects = [
    {
      ...
      outcome: "The repository is private due to company policy. You can access the login page, but credentials are not provided as this system is not for public use.",
    ...
    },
    {
      ...
      outcome: "That project is a work in progress and because of that link is not active yet.",
      image: "/FlatMate.png",
    },
    {
      id: 3,
